...
export const INTAKE_EVAL_CASES: IntakeEvalCase[] = [
  {
    ...
    expected: {
      ...
      requiredFields: ["price", "eps", "roe", "invested"],
    ...
    passingOutput: {
      ...
      fields: [
        ...
        { key: "roe", value: 15, source: "inferred" },
      ],
      thesis: {
        ...emptyThesis,
  ...
  },
  {
    ...
    passingOutput: {
      ...
      note: "Price, EPS, and ROE were visible in the research evidence.",
      fields: [
        { key: "price", value: 9000, source: "inferred" },
        { key: "eps", value: 600, source: "inferred" },
        { key: "roe", value: 20, source: "inferred" },
      ],
      thesis: {
        ...emptyThesis,
