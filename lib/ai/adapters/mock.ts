          ...
          candidates: [
            {
              ...
              citation: 'Palantir FY2026 10-K, Government segment revenue disclosure.',
            },
            {
              ticker: 'LMT',
              ...
              citation: 'Lockheed Martin FY2026 10-K, segment backlog disclosure.',
            },
            {
              ticker: 'RTX',
              companyName: 'RTX Corporation',
              market: 'US',
              rationale: 'Diversified defense and aerospace supplier with growing missile-defense backlog.',
              citation: 'RTX FY2026 10-K, segment backlog disclosure.',
            },
          ],
        },
      };
