...
| LC-20260708-001 | `candidate` | `quality` | M001 | Playwright mutation-triggered navigation checks should synchronize on app-owned API responses before asserting the destination route | [LC-20260708-001](candidates/LC-20260708-001-playwright-navigation-synchronization.md) |  |
